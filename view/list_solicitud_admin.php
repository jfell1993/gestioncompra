		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<table class="table table-bordered table-striped table-hover" id="table_bandeja">
					...
					<tbody>
					<?php foreach($this->model_sol->List($_SESSION['estado']) as $row): ?>
		            <tr>
			            ...
			            <td align="center"><a class="btn btn-primary" href="?c=Solicitud&a=Form_solicitud_read&id=<?php echo $row->id_solicitud ?>" style="margin-right:5px"><i class="glyphicon glyphicon-eye-open"></i></a><a class="btn btn-primary" href="?c=Solicitud&a=Form_solicitud_edit&id=<?php echo $row->id_solicitud ?>"><i class="glyphicon glyphicon-edit"></i></a></td>
		            </tr>
		            <?php endforeach; ?>
